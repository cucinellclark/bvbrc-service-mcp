...
service_api_url = os.getenv('SERVICE_API_URL', 'https://p3.theseed.org/services/app_service')
kb_auth_token = os.getenv('KB_AUTH_TOKEN')
api = JsonRpcCaller(service_api_url)

# Create FastMCP server
mcp = FastMCP("BV-BRC Service MCP Server")

def get_user_id() -> str:
    """
    Extract user ID from environment token.
    ...
    try:
        user_id = kb_auth_token.split('|')[0].replace('un=','')
        return user_id
...
def service_enumerate_apps() -> List[str]:
    """Enumerate all apps."""
    user_id = get_user_id()
    return enumerate_apps(api, token=kb_auth_token, user_id=user_id)

@mcp.tool()
def service_start_date_app(output_path: str = None, output_file: str = None) -> str:
    """Start the date app. Parameters: output_path (str, required) - Path for output files, output_file (str, required) - Name of output file"""
    user_id = get_user_id()
    return start_date_app(api, token=kb_auth_token, user_id=user_id, output_path=output_path, output_file=output_file)

# Genomics Analysis Services

@mcp.tool()
def service_start_genome_assembly_app(paired_end_libs: List[Dict] = None, single_end_libs: List[Dict] = None, srr_ids: List[str] = None, max_bases: int = 10000000000, recipe: str = "auto", racon_iter: int = 2, pilon_iter: int = 2, trim: bool = False, target_depth: int = 200, normalize: bool = False, filtlong: bool = False, genome_size: int = 5000000, min_contig_len: int = 300, min_contig_cov: float = 5.0, output_path: str = None, output_file: str = None) -> str:
...
def service_start_blast_app(input_type: str = None, input_source: str = None, input_fasta_data: str = None, input_id_list: List[str] = None, input_fasta_file: str = None, input_feature_group: str = None, input_genome_group: str = None, db_type: str = None, db_source: str = None, db_fasta_data: str = None, db_fasta_file: str = None, db_id_list: List[str] = None, db_feature_group: str = None, db_genome_group: str = None, db_genome_list: List[str] = None, db_taxon_list: List[str] = None, db_precomputed_database: str = None, blast_program: str = None, blast_evalue_cutoff: float = 1e-5, blast_max_hits: int = 300, blast_min_coverage: int = None, output_path: str = None, output_file: str = None) -> str:
    ...
    """
    user_id = get_user_id()
    return start_blast_app(api, token=kb_auth_token, user_id=user_id, input_type=input_type, input_source=input_source, input_fasta_data=input_fasta_data, input_id_list=input_id_list, input_fasta_file=input_fasta_file, input_feature_group=input_feature_group, input_genome_group=input_genome_group, db_type=db_type, db_source=db_source, db_fasta_data=db_fasta_data, db_fasta_file=db_fasta_file, db_id_list=db_id_list, db_feature_group=db_feature_group, db_genome_group=db_genome_group, db_genome_list=db_genome_list, db_taxon_list=db_taxon_list, db_precomputed_database=db_precomputed_database, blast_program=blast_program, blast_evalue_cutoff=blast_evalue_cutoff, blast_max_hits=blast_max_hits, blast_min_coverage=blast_min_coverage, output_path=output_path, output_file=output_file)

@mcp.tool()
def service_start_primer_design_app(output_file: str = None, output_path: str = None, input_type: str = None, sequence_input: str = None, SEQUENCE_ID: str = None, SEQUENCE_TARGET: List[List[int]] = None, SEQUENCE_INCLUDED_REGION: List[int] = None, SEQUENCE_EXCLUDED_REGION: List[int] = None, SEQUENCE_OVERLAP_JUNCTION_LIST: List[List[int]] = None, PRIMER_PICK_INTERNAL_OLIGO: int = None, PRIMER_PRODUCT_SIZE_RANGE: List[List[int]] = None, PRIMER_NUM_RETURN: int = None, PRIMER_MIN_SIZE: int = None, PRIMER_OPT_SIZE: int = None, PRIMER_MAX_SIZE: int = None, PRIMER_MAX_TM: float = None, PRIMER_MIN_TM: float = None, PRIMER_OPT_TM: float = None, PRIMER_PAIR_MAX_DIFF_TM: float = None, PRIMER_MAX_GC: float = None, PRIMER_MIN_GC: float = None, PRIMER_OPT_GC: float = None, PRIMER_SALT_MONOVALENT: float = None, PRIMER_SALT_DIVALENT: float = None, PRIMER_DNA_CONC: float = None, PRIMER_DNTP_CONC: float = None) -> str:
...
def service_start_variation_app(reference_genome_id: str = None, paired_end_libs: List[Dict] = None, single_end_libs: List[Dict] = None, srr_ids: List[str] = None, mapper: str = "BWA-mem", caller: str = "FreeBayes", output_path: str = None, output_file: str = None) -> str:
    ...
    """
    user_id = get_user_id()
    return start_variation_app(api, token=kb_auth_token, user_id=user_id, reference_genome_id=reference_genome_id, paired_end_libs=paired_end_libs, single_end_libs=single_end_libs, srr_ids=srr_ids, mapper=mapper, caller=caller, output_path=output_path, output_file=output_file)

@mcp.tool()
def service_start_tnseq_app(experimental_conditions: List[str] = None, contrasts: List[str] = None, read_files: List[Dict] = None, reference_genome_id: str = None, recipe: str = "gumbel", protocol: str = "sassetti", primer: str = "", output_path: str = None, output_file: str = None) -> str:
    ...
    """
    user_id = get_user_id()
    return start_tnseq_app(api, token=kb_auth_token, user_id=user_id, experimental_conditions=experimental_conditions, contrasts=contrasts, read_files=read_files, reference_genome_id=reference_genome_id, recipe=recipe, protocol=protocol, primer=primer, output_path=output_path, output_file=output_file)

# Phylogenomics Services

@mcp.tool()
def service_start_bacterial_genome_tree_app(output_path: str = None, output_file: str = None, genome_ids: List[str] = None, genome_groups: List[str] = None, optional_genome_ids: List[str] = None, genome_metadata_fields: str = None, number_of_genes: int = 20, bootstraps: int = 100, max_genomes_missing: int = 0, max_allowed_dups: int = 0) -> str:
...
def service_start_gene_tree_app(sequences: List[str] = None, alignment_program: str = None, trim_threshold: float = None, gap_threshold: float = None, alphabet: str = None, substitution_model: str = None, bootstrap: int = None, recipe: str = "RAxML", tree_type: str = None, feature_metadata_fields: str = None, genome_metadata_fields: str = None, output_path: str = None, output_file: str = None) -> str:
    ...
    """
    user_id = get_user_id()
    return start_gene_tree_app(api, token=kb_auth_token, user_id=user_id, sequences=sequences, alignment_program=alignment_program, trim_threshold=trim_threshold, gap_threshold=gap_threshold, alphabet=alphabet, substitution_model=substitution_model, bootstrap=bootstrap, recipe=recipe, tree_type=tree_type, feature_metadata_fields=feature_metadata_fields, genome_metadata_fields=genome_metadata_fields, output_path=output_path, output_file=output_file)

@mcp.tool()
def service_start_core_genome_mlst_app(input_genome_type: str = "genome_group", analysis_type: str = "chewbbaca", input_genome_group: str = None, input_genome_fasta: str = None, schema_location: str = None, input_schema_selection: str = None, output_path: str = None, output_file: str = None) -> str:
    ...
    """
    user_id = get_user_id()
    return start_core_genome_mlst_app(api, token=kb_auth_token, user_id=user_id, input_genome_type=input_genome_type, analysis_type=analysis_type, input_genome_group=input_genome_group, input_genome_fasta=input_genome_fasta, schema_location=schema_location, input_schema_selection=input_schema_selection, output_path=output_path, output_file=output_file)

@mcp.tool()
def service_start_whole_genome_snp_app(input_genome_type: str = None, majority_threshold: float = 0.5, min_mid_linkage: int = 10, max_mid_linkage: int = 40, analysis_type: str = "Whole Genome SNP Analysis", input_genome_group: str = None, input_genome_fasta: str = None, output_path: str = None, output_file: str = None) -> str:
...
@mcp.tool()
def service_start_metagenomic_read_mapping_app(gene_set_type: str = None, gene_set_name: str = None, gene_set_fasta: str = None, gene_set_feature_group: str = None, paired_end_libs: Dict = None, single_end_libs: Dict = None, srr_ids: str = None, output_path: str = None, output_file: str = None) -> str:
...
@mcp.tool()
def service_start_sequence_submission_app(input_source: str = None, input_fasta_data: str = None, input_fasta_file: str = None, input_genome_group: str = None, metadata: str = None, affiliation: str = None, first_name: str = None, last_name: str = None, email: str = None, consortium: str = None, country: str = None, phoneNumber: str = None, street: str = None, postal_code: str = None, city: str = None, state: str = None, numberOfSequences: str = None, output_path: str = None, output_file: str = None) -> str:
    ...
    """
    user_id = get_user_id()
    return start_sequence_submission_app(api, token=kb_auth_token, user_id=user_id, input_source=input_source, input_fasta_data=input_fasta_data, input_fasta_file=input_fasta_file, input_genome_group=input_genome_group, metadata=metadata, affiliation=affiliation, first_name=first_name, last_name=last_name, email=email, consortium=consortium, country=country, phoneNumber=phoneNumber, street=street, postal_code=postal_code, city=city, state=state, numberOfSequences=numberOfSequences, output_path=output_path, output_file=output_file)

@mcp.tool()
def service_start_influenza_ha_subtype_conversion_app(input_source: str = None, input_fasta_data: str = None, input_fasta_file: str = None, input_feature_group: str = None, input_feature_list: str = None, types: str = None, output_path: str = None, output_file: str = None) -> str:
    ...
    """
    user_id = get_user_id()
    return start_influenza_ha_subtype_conversion_app(api, token=kb_auth_token, user_id=user_id, input_source=input_source, input_fasta_data=input_fasta_data, input_fasta_file=input_fasta_file, input_feature_group=input_feature_group, input_feature_list=input_feature_list, types=types, output_path=output_path, output_file=output_file)

@mcp.tool()
def service_start_subspecies_classification_app(input_source: str = None, input_fasta_data: str = None, input_fasta_file: str = None, input_genome_group: str = None, ref_msa_fasta: str = None, virus_type: str = None, output_path: str = None, output_file: str = None) -> str:
    ...
    """
    user_id = get_user_id()
    return start_subspecies_classification_app(api, token=kb_auth_token, user_id=user_id, input_source=input_source, input_fasta_data=input_fasta_data, input_fasta_file=input_fasta_file, input_genome_group=input_genome_group, ref_msa_fasta=ref_msa_fasta, virus_type=virus_type, output_path=output_path, output_file=output_file)

@mcp.tool()
def service_start_viral_assembly_app(paired_end_lib: Dict = None, single_end_lib: Dict = None, srr_id: str = None, recipe: str = "auto", module: str = None, viral_size: str = "5M", output_path: str = None, output_file: str = None) -> str:
    ...
    """
    user_id = get_user_id()
    return start_viral_assembly_app(api, token=kb_auth_token, user_id=user_id, paired_end_lib=paired_end_lib, single_end_lib=single_end_lib, srr_id=srr_id, recipe=recipe, module=module, viral_size=viral_size, output_path=output_path, output_file=output_file)

# Query Tasks

@mcp.tool()
def service_query_tasks(task_ids: List[str] = None) -> str:
    """Query tasks. Parameters: task_ids (List[str]) - List of task IDs to query"""
    user_id = get_user_id()
    params = {"task_ids": task_ids} if task_ids else None
    return query_tasks(api, token=kb_auth_token, user_id=user_id, params=params)

def main() -> int:
    print("Starting BV-BRC Service MCP FastMCP Server...", file=sys.stderr)
    try:
        mcp.run()
