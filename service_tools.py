...
def register_all_tools(mcp: FastMCP, api: JsonRpcCaller, similar_genome_finder_api: JsonRpcCaller, token_provider):
    ...
    @mcp.tool(name="submit_date_app", description="Start the date app. Parameters defined in the date_app_prompt.")
    ...
    @mcp.tool(name="submit_genome_assembly_app", description="Submit a genome assembly application. Parameters defined in the genome_assembly_app_prompt.")
    ...
    @mcp.tool(name="submit_genome_annotation_app", description="Call genes and functionally annotate input contig set using RASTtk pipeline. Parameters defined in the genome_annotation_app_prompt.")
    ...
    @mcp.tool(name="submit_comprehensive_genome_analysis_app", description="Perform comprehensive genome analysis from reads, contigs, or GenBank files. Parameters defined in the comprehensive_genome_analysis_app_prompt.")
    ...
    @mcp.tool(name="submit_blast_app", description="Perform homology searches on sequence data using BLAST algorithms. Parameters defined in the blast_app_prompt.")
    ...
    @mcp.tool(name="submit_primer_design_app", description="Use Primer3 to design primers for given DNA sequences. Parameters defined in the primer_design_app_prompt.")
    ...
    @mcp.tool(name="submit_variation_app", description="Identify and annotate small nucleotide variations (SNVs) relative to a reference genome. Parameters defined in the variation_app_prompt.")
    ...
    @mcp.tool(name="submit_tnseq_app", description="Analyze TnSeq (Transposon Sequencing) data using TRANSIT pipeline. Parameters defined in the tnseq_app_prompt.")
...
# Phylogenomics Services
    ...
    @mcp.tool(name="submit_bacterial_genome_tree_app", description="Compute phylogenetic tree from PGFam protein and DNA sequences. Parameters defined in the bacterial_genome_tree_app_prompt.")
    ...
    @mcp.tool(name="submit_gene_tree_app", description="Estimate phylogeny of gene or other sequence features. Parameters defined in the gene_tree_app_prompt.")
    ...
    @mcp.tool(name="submit_core_genome_mlst_app", description="Evaluate core genomes from a set of genome groups of the same species. Parameters defined in the core_genome_mlst_app_prompt.")
    ...
    @mcp.tool(name="submit_whole_genome_snp_app", description="Identify SNP differences in a genome group with genomes of the same species. Parameters defined in the whole_genome_snp_app_prompt.")
...
# Metagenomics Services
    ...
    @mcp.tool(name="submit_taxonomic_classification_app", description="Compute taxonomic classification for read data using metagenomic analysis. Parameters defined in the taxonomic_classification_app_prompt.")
    ...
    @mcp.tool(name="submit_metagenomic_binning_app", description="Assemble, bin, and annotate metagenomic sample data. Parameters defined in the metagenomic_binning_app_prompt.")
    ...
    # @mcp.tool()
    @mcp.tool(name="submit_metagenomic_read_mapping_app", description="Map metagenomic reads to a defined gene set for functional analysis. Parameters defined in the metagenomic_read_mapping_app_prompt.")
...
# Transcriptomics Services
    ...
    @mcp.tool(name="submit_rnaseq_app", description="Align or assemble RNA-seq reads into transcripts with normalized expression levels. Parameters defined in the rnaseq_app_prompt.")
    ...
    @mcp.tool(name="submit_expression_import_app", description="Parse and transform user differential expression data. Parameters defined in the expression_import_app_prompt.")
...
# Viral Services
    ...
    @mcp.tool(name="submit_sars_wastewater_analysis_app", description="Assemble SARS-CoV-2 reads into consensus sequences for wastewater surveillance. Parameters defined in the sars_wastewater_analysis_app_prompt.")
    ...
    @mcp.tool(name="submit_sequence_submission_app", description="Submit sequences to public databases with comprehensive metadata. Parameters defined in the sequence_submission_app_prompt.")
    ...
    @mcp.tool(name="submit_influenza_ha_subtype_conversion_app", description="Convert HA subtype numbering for influenza hemagglutinin sequences. Parameters defined in the influenza_ha_subtype_conversion_app_prompt.")
    ...
    @mcp.tool(name="submit_subspecies_classification_app", description="Classify viral subspecies using sequence analysis and reference alignments. Parameters defined in the subspecies_classification_app_prompt.")
    ...
    @mcp.tool(name="submit_viral_assembly_app", description="Assemble viral reads into consensus sequences using specialized viral assembly strategies. Parameters defined in the viral_assembly_app_prompt.")
    ...
    # @mcp.tool()
    @mcp.tool(name="submit_genome_alignment_app", description="Align multiple genomes using progressiveMauve or other alignment algorithms. Parameters defined in the genome_alignment_app_prompt.")
    ...
    @mcp.tool(name="submit_sars_genome_analysis_app", description="Assemble SARS-CoV-2 genome from sequencing reads. Parameters defined in the sars_genome_analysis_app_prompt.")
    ...
    @mcp.tool(name="submit_msa_snp_analysis_app", description="Analyze SNPs in multiple sequence alignments. Parameters defined in the msa_snp_analysis_app_prompt.")
    ...
    @mcp.tool(name="submit_metacats_app", description="Perform metagenomic analysis of community temporal dynamics. Parameters defined in the metacats_app_prompt.")
    ...
    @mcp.tool(name="submit_proteome_comparison_app", description="Compare proteomes across multiple genomes. Parameters defined in the proteome_comparison_app_prompt.")
    ...
    @mcp.tool(name="submit_comparative_systems_app", description="Compare genomic systems across multiple genomes. Parameters defined in the comparative_systems_app_prompt.")
    ...
    @mcp.tool(name="submit_docking_app", description="Perform molecular docking simulations. Parameters defined in the docking_app_prompt.")
    ...
    @mcp.tool(name="submit_similar_genome_finder_app", description="Find similar genomes using sequence similarity. Parameters defined in the similar_genome_finder_app_prompt.")
    ...
    @mcp.tool(name="submit_fastqutils_app", description="Perform quality control and processing on FASTQ sequencing data. Parameters defined in the fastqutils_app_prompt.")
